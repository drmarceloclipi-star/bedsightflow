...
/**
 * AdminHome — Global Admin (institution-level) home panel.
 *
 * The Global Admin manages their institution within the software:
 *   - Manages units of the institution
 *   - Accesses institutional resources
 *   - Supervises operations below
 *
 * The Global Admin does NOT:
 *   - Manage other institutions (that's Super Admin)
 *   - Manage global authorized users (that's Super Admin)
 *   - Access the SaaS platform layer (that's Super Admin)
 */
        ...
        <div className="admin-shell">
            ...
            <header className="admin-header">
                <div className="admin-header-top relative">
                    <div className="admin-header-left">
                        <span className="unit-badge">Global Admin</span>
                    </div>
            ...
            <main className="admin-main">
                <div className="admin-home-header-group">
                    <h1 className="text-2xl font-serif text-primary mb-1">Painel da Instituição</h1>
                    <p className="text-sm text-muted">
                        Selecione uma unidade para gerenciar dentro da sua instituição.
                    </p>
                </div>
                ...
                <div className="admin-section-grid">
                    <div className="flex justify-between items-center mb-4 col-span-full">
                        <h2 className="text-lg font-semibold text-primary">Unidades da Instituição ({units.length})</h2>
                    </div>
                    {units.length === 0 ? (
